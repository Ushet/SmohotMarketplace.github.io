...
.remember_me input[type="checkbox"]:checked + span:before {
    border-color: #2196F3 !important;
}

.remember_me input[type="checkbox"]:checked + span:after {
...
<div class="center">
    ...
    <form method="post">
        ...
        <div class="signup_link">
            Don't have an account? <a href="sign_up.php">Signup</a>
        </div>
    </form>
</div>
