<?php include('navigation.php'); ?>
    ...
    <div class="container" >
     ...
     <div class="carousel carousel-slider center" id="mainCarousel">
        <div class="carousel-item"><img src="images/image (23).jpg" class="responsive-img" loading="lazy"></div>
        <div class="carousel-item"><img src="images/image (13).jpg" class="responsive-img" loading="lazy"></div>
        <div class="carousel-item"><img src="images/image (14).jpg" class="responsive-img" loading="lazy"></div>
        <div class="carousel-item"><img src="images/image (22).jpg" class="responsive-img" loading="lazy"></div>
        <div class="carousel-item"><img src="images/image (3).jpg" class="responsive-img" loading="lazy"></div>
        <div class="carousel-item"><img src="images/image (5).jpg" class="responsive-img" loading="lazy"></div>
        <div id="slide-counter" class="carousel-counter"></div>
    </div>
        ...
        <div class="row">
            <div class="col s12">
                        <p class="price " style="margin-bottom: 5px;">MWK 260,000.00</p>
                        <p class="item" >Nicon Camera</p>
                        <p class="location styled-paragraph" ><i class="material-icons blue-text">location_on</i> Malawi, Zomba/Today</p>

                        <div class="input-field" style="margin-top: 30px;">
                            <textarea id="message" class="materialize-textarea">Is this still available?</textarea>
                            <label for="message">Message Seller</label>
                        </div>
                        <button class="btn waves-effect waves blue" type="submit" name="action">Send</button>

                        <div class="card-panel grey lighten-5 z-depth-1"  style="margin-top: 20px;"> 
                        <div class="row valign-wrapper" style="height: 50px;"> 
                        <div class="col s1" style="width: 100px; height: 90px; margin-top: 20px;">
                        ...
                        <div class="col s2 follow-button">
                        <a class="waves-effect waves blue btn">follow</a>
                        </div>
                 </div>
            </div>

        <p class="description styled-paragraph">Description</p>
        <p class=" styled-paragraph">G-Anica ,Digital Camera for Photography and Video 16X Digital Zoom 4K 48MP Vlogging Camera for with 180° Flip Screen. 
            G-Anica Digital Camere, 4k&64MP Cameras for Photography ,Video Camera,40X zoom Camera for YouTube with Flash, WiFi & HDMI Output</p>
        <p class="condition ">Condition</p>
        <p class=" styled-paragraph">New</p>
    </div>
</div>
                ...
                <div class="fixed-action-btn">
                    <!-- Your new button -->
                    <a class="btn-floating waves-effect btn-large blue" style="position: absolute; top: -60px; left: 0;">
                        <i class="large material-icons">priority_high</i>
                    </a>
                    <!-- Your share button -->
                    <a class="btn-floating waves-effect btn-large blue pulse">
...
// Carousel Slider
document.addEventListener('DOMContentLoaded', function() {
    // Initialize the carousel and update the counter
    ...
    var instance = M.Carousel.init(carousel, {
        fullWidth: true,
        indicators: true,
        duration: 200, // Adjust the duration for smoother transitions
        onCycleTo: updateCounter // Call updateCounter whenever the slide changes
    });
    ...
    // Prevent default link behavior on carousel items
...
// Add click event listener to the card after the DOM is fully loaded
document.addEventListener('DOMContentLoaded', function() {
