...
<body>
    <div class="center">
        ...
        <form method="post">
            <p class="instructions">Forgot your password? Please enter your phone number or email address.
                 You will receive a link to create a new password via email or text message.</p>
            <div class="txt_field">
