<?php include('navigation.php'); ?>
    ...
    <div class="container" style="width: 100%;">
        ...
        <h5 class="calls" style="font-weight: 500; margin-top: 40px; margin-bottom: 20px;">Recent</h5>
        <div id="calls" class="col s12">            
                
            <div class="card-panel unique-card-panel grey lighten-5 z-depth-1" style="margin-top: 10px; margin-bottom: 10px;"> <!-- Adjust margin-bottom to create space between elements -->
                <div class="row valign-wrapper" style="height: 40px;"> 
                    <div class="col s1" style="width: 80px; height: 70px; margin-top: 20px; margin-left: 5px;"> <!-- Adjust width and height as needed -->
                        <img src="images/image (11).jpg" alt="" class="circle" style="width: 100%; height: 100%;">
                    </div>
                    <div class="col s10" style=" margin-left: 5px;">
                        <span class="black-text" id="myCard" >
                            <span style="font-size: 16px; padding-top: 70px;">Malawi Electronics Ltd</span><br>
                            <i class="material-icons blue-text" style="display: inline; font-size: 24px;">call_received</i>
                            <i class="material-icons blue-text" style="display: inline;">location_on</i> 
                            <span style="font-size: 12px;">Malawi, Lilongwe</span> 
                            <span style="font-size: 12px;">Today, 10:00</span>
                        </span>
                    </div>
                    <div class="col s1 phone-icon" style="margin-top: 20px; margin-right: -40px;">
                        <i class="material-icons blue-text" style="font-size: 34px;">videocam</i>
                    </div>
                </div>
            </div>
             ...
             <div class="card-panel unique-card-panel grey lighten-5 z-depth-1" style="margin-top: 10px; margin-bottom: 10px;"> <!-- Adjust margin-bottom to create space between elements -->
                <div class="row valign-wrapper" style="height: 40px;"> 
                    ...
                    <div class="col s10" style=" margin-left: 5px;">
                        <span class="black-text" id="myCard" >
                            <span style="font-size: 16px; padding-top: 70px;">Malawi Electronics Ltd(5)</span><br>
                            <i class="material-icons blue-text" style="display: inline; font-size: 24px;">call_made</i>
                            <i class="material-icons blue-text" style="display: inline;">location_on</i> 
                            <span style="font-size: 12px;">Malawi, Lilongwe</span> 
                            <span style="font-size: 12px;">Yetserday, 7:00</span>
                        </span>
                    </div>
                    <div class="col s1 phone-icon" style=" margin-right: -40px;">
                        <i class="material-icons blue-text" style="font-size: 34px;">call</i>
                    </div>
                </div>
            </div>
             ...
             <div class="card-panel unique-card-panel grey lighten-5 z-depth-1" style="margin-top: 10px; margin-bottom: 10px;"> <!-- Adjust margin-bottom to create space between elements -->
                <div class="row valign-wrapper" style="height: 40px;"> 
                    <div class="col s1" style="width: 80px; height: 70px; margin-top: 20px; margin-left: 5px;"> <!-- Adjust width and height as needed -->
                        <img src="images/image (10).jpg" alt="" class="circle" style="width: 100%; height: 100%;">
                    </div>
                    <div class="col s10" style=" margin-left: 5px;">
                        <span class="black-text" id="myCard" >
                            <span style="font-size: 16px; padding-top: 70px; color: red;">Usher265</span><br>
                            <i class="material-icons red-text" style="display: inline; font-size: 24px;">call_received</i>
                            <i class="material-icons blue-text" style="display: inline;">location_on</i> 
                            <span style="font-size: 12px;">Malawi, Mzuzu</span> 
                            <span style="font-size: 12px;">March 20, 17:20</span>
                        </span>
                    </div>
                    <div class="col s1 phone-icon" style="margin-top: 20px; margin-right: -40px;">
                        <i class="material-icons blue-text" style="font-size: 34px;">videocam</i>
             ...
             <div class="card-panel unique-card-panel grey lighten-5 z-depth-1" style="margin-top: 10px; margin-bottom: 10px;"> <!-- Adjust margin-bottom to create space between elements -->
                <div class="row valign-wrapper" style="height: 40px;"> 
                    <div class="col s1" style="width: 80px; height: 70px; margin-top: 20px; margin-left: 5px;"> <!-- Adjust width and height as needed -->
                        <img src="images/image (1).jpg" alt="" class="circle" style="width: 100%; height: 100%;">
                    </div>
                    <div class="col s10" style=" margin-left: 5px;">
                        <span class="black-text" id="myCard" >
                            <span style="font-size: 16px; padding-top: 70px;">Mary(2)</span><br>
                            <i class="material-icons blue-text" style="display: inline; font-size: 24px;">call_received</i>
                            <i class="material-icons blue-text" style="display: inline;">location_on</i> 
                            <span style="font-size: 12px;">Malawi, Karonga</span> 
                            <span style="font-size: 12px;">March 20, 16:00</span>
                        </span>
                    </div>
                    <div class="col s1 phone-icon" style="margin-top: 20px; margin-right: -40px;">
                        <i class="material-icons blue-text" style="font-size: 34px;">videocam</i>
            ...
            <div class="card-panel unique-card-panel grey lighten-5 z-depth-1" style="margin-top: 10px; margin-bottom: 10px;"> <!-- Adjust margin-bottom to create space between elements -->
                <div class="row valign-wrapper" style="height: 40px;"> 
                    ...
                    <div class="col s10" style=" margin-left: 5px;">
                        <span class="black-text" id="myCard" >
                            ...
                            <i class="material-icons blue-text" style="display: inline;">location_on</i> 
                            <span style="font-size: 12px;">Malawi, Mzuzu</span> 
                            <span style="font-size: 12px;">March 20, 16:40</span>
                        </span>
                    </div>
                    <div class="col s1 phone-icon" style="margin-top: 20px; margin-right: -40px;">
                        <i class="material-icons blue-text" style="font-size: 34px;">call</i>
             ...
             <div class="card-panel unique-card-panel grey lighten-5 z-depth-1" style="margin-top: 10px; margin-bottom: 70px;">
                <div class="row valign-wrapper" style="height: 40px;"> 
                    <div class="col s1" style="width: 80px; height: 70px; margin-top: 20px; margin-left: 5px;"> 
                        <img src="images/image (11).jpg" alt="" class="circle" style="width: 100%; height: 100%;">
                    </div>
                    <div class="col s10" style=" margin-left: 5px;">
                        <span class="black-text" id="myCard" >
                            ...
                            <i class="material-icons blue-text" style="display: inline;">location_on</i> 
                            <span style="font-size: 12px;">Malawi, Lilongwe</span> 
                            <span style="font-size: 12px;">March 15, 17:00</span>
                        </span>
                    </div>
                    <div class="col s1 phone-icon" style="margin-top: 20px; margin-right: -40px;">
                        <i class="material-icons blue-text" style="font-size: 34px;">call</i>
